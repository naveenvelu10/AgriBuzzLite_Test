    ...
    <div class="container">
      <div class="header-container d-flex align-items-center">
        <div class="logo mr-auto">
          <h1 class="text-light"><a href="index.php"><span>ONLINE BIOMART</span></a></h1>
...
<li class="drop-down <?php
  ...
  <ul>
    ...
    <li><a href="workerpanel.php?workschedule=set" onclick="window.location='workerpanel.php?workschedule=set'">Work Schedule</a></li>
	<li><a href="logout.php">Logout</a></li>
  </ul>
</li>
<?php
