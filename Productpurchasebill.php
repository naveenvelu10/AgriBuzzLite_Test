...
if(isset($_POST['submit']))
{
	...
	{
		$sql ="UPDATE product_purchase_bill SET `state_id`='$_POST[state]', `city_id`='$_POST[city]', `customer_name`='$_POST[customername]', `customer_address`='$_POST[customeraddress]', `pincode`='$_POST[pincode]', `customer_contact_number`='$_POST[contactnumber]', `purchase_date`='', `status`='$_POST[status]' WHERE product_purchase_bill_id='$_GET[editid]'";
	...
	{
$sql="INSERT INTO `product_purchase_bill`(`state_id`, `city_id`, `customer_name`, `customer_address`, `pincode`, `customer_contact_number`, `purchase_date`, `status`) VALUES ('$_POST[state]','$_POST[city]','$_POST[customername]','$_POST[customeraddress]','$_POST[pincode]','$_POST[contactnumber]','','$_POST[status]')";
if(!mysqli_query($con,$sql))
	{
		echo "Error in mysqli query";
	}
