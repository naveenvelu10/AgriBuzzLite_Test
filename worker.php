...
if($_SESSION['randnumber']  == $_POST['randnumber'])
{
	if(isset($_POST['submit']))
	{
		...
		if(isset($_GET['editid']))
		{
			$sql ="UPDATE worker SET name='$_POST[name]', address='$_POST[address]', state_id='$_POST[state]', city_id='$_POST[city]',  pincode='$_POST[pincode]',contactno='$_POST[contct]', work_profile='$_POST[workprofile]', biodata='$imgname1', date_of_birth='$_POST[dob]', login_id='$_POST[loginid]', password='$_POST[password]', expected_salary='$_POST[expectedsalary]', status='Active'";
		...
		{
			$sql="INSERT INTO worker( name, address, state_id, city_id,  pincode, contactno, work_profile, biodata, date_of_birth, login_id, password, expected_salary, status) VALUES ('$_POST[name]','$_POST[address]','$_POST[state]','$_POST[city]','$_POST[pincode]','$_POST[contct]','$_POST[workprofile]','$imgname1','$_POST[dob]','$_POST[loginid]','$_POST[password]','$_POST[expectedsalary]','Active')";
			if(!mysqli_query($con,$sql))
				{
