...
<?php
							...
							<table ID="datatable" class="table table-striped table-bordered"  style="width:100%">
						      ...
						      <td>&nbsp;$rs[customer_contact_number]</td>
							    <td>&nbsp;  <a href='Productpurchasebill.php?editid=$rs[product_purchase_bill_id]'>Edit</a> |  <a href='viewProductpurchasebill.php?deleteid=$rs[product_purchase_bill_id]'onclick='return delconfirm()'class='btn btn-danger' >Delete</a></td>
						      </tr>";
							  }
							  ?>
								</TBODY>
