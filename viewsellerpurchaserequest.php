...
<?php
							$sql = "SELECT *, purchase_request.quantity as pur_req_qty, purchase_request.status as pur_req_st FROM `purchase_request` INNER JOIN product ON product.product_id=purchase_request.product_id  WHERE product.seller_id='$_SESSION[sellerid]'";
						    ...
						    <tr>
						      <td>&nbsp;$rs1[title]</td>
						      <td>&nbsp;$rs[pur_req_qty] $rs1[quantity_type]</td>
...
if(($rs['pur_req_st'] == "Pending") && $date1 < $date2)
{
