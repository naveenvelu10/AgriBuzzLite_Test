...
<tr>
  ...
  <?php
							  ...
							  <tr>
							    ...
							    <td>&nbsp;$rs[login_id]</td>
							    <td>&nbsp;$rs[status]</td>
								 <td>&nbsp; <a href='admin.php?editid=$rs[admin_id]' CLASS='btn btn-info'>Edit</a> |<a href='viewadmin.php?deleteid=$rs[admin_id]' onclick='return delconfirm()'  CLASS='btn btn-danger' class='btn btn-danger' >Delete</a></td>
						      </tr>";
							  }
  ?>
  </tbody>
