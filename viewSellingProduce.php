...
<?php
						    ...
						    <tr>
						      ...
						      <td>&nbsp;$rs[status]</td>
							   <td>&nbsp; <a href='Product.php?editid=$rs[product_id]' CLASS='btn btn-info'>Edit</a> <a href='viewProduct.php?deleteid=$rs[product_id]' onclick='return delconfirm()' CLASS='btn btn-danger'class='btn btn-danger' >Delete</a></td>
					        </tr>";
							  }
							  ?>
								</TBODY>
