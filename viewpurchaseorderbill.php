		...
		<center><h4>View Purchase Request Detail...</h4></center><hr>
							...
							<table class="table table-striped table-bordered"  style="width:100%">
						      ...
						      <th><strong>Status</strong></th>
								...
								<TBODY>
<?php
							  $sql = "SELECT *, purchase_request.quantity as pur_req_qty, purchase_request.status as pur_req_st FROM `purchase_request` INNER JOIN product ON product.product_id=purchase_request.product_id  WHERE product.seller_id='$_SESSION[sellerid]' AND purchase_request.purchase_request_id='$_GET[purchaserequestid]'";
							  $qsql = mysqli_query($con,$sql);
...
<input type="hidden" name="quantity" value="<?php echo $rs['pur_req_qty']; ?>" >
 ...
 <tbody>
        ...
        <tr>
		 ...
		 $rspro = mysqli_fetch_array($qsqlproduct);
		  ...
		  ?>)</td>
          <td><input type="text" name="qty" id="qty" value="<?php echo $rs['pur_req_qty']; ?>" readonly class="form-control"></td>
        </tr>
        <tr>
          <td>Price:&nbsp;</td>
