...
<?php
						    ...
						    <tr>
						      ...
						      <td><a href='worker.php?editid=$rs[worker_id]' class='btn btn-info' style='width: 100%;'>Edit</a> 
							  <a href='viewworker.php?deleteid=$rs[worker_id]' onclick='return delconfirm()'class='btn btn-danger' style='width: 100%;' >Delete</a><br>
<a href='imgworker/$rs[biodata]' class='btn btn-primary' style='width: 100%;'>Download Bio data</a>							  
							  </td>
					        </tr>";
							  }
							  ?>
