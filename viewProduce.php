...
<tr>
  ...
  while($rs = mysqli_fetch_array($qsql))
  {
        					  ...
        					  <tr>
							    ...
							    <td>&nbsp;$rs[status]</td>
								  <td>&nbsp; <a href='Produce.php?editid=$rs[produce_id]'  CLASS='btn btn-info'>Edit</a>| <a href='viewProduce.php?deleteid=$rs[produce_id]' onclick='return delconfirm()'  CLASS='btn btn-danger'class='btn btn-danger' >Delete</a></td>
						      </tr>";
  }
  ?>
  </tbody>
