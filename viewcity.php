  ...
  while($rs = mysqli_fetch_array($qsql))
  {
	  ...
	  $rsstate = mysqli_fetch_array($qsqlstate);
							  ...
							  <tr>
								...
								<td>&nbsp; <a href='city.php?editid=$rs[city_id]'  CLASS='btn btn-info'>Edit</a>| <a href='viewcity.php?deleteid=$rs[city_id]' onclick='return delconfirm()' CLASS='btn btn-danger'class='btn btn-danger' >Delete</a></td>
						      </tr>";
  }
  ?>
  </tbody>
