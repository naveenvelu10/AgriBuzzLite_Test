...
<tr>
  ...
  <tr>
	...
	<td>&nbsp;$rs[status]</td>
	 <td>&nbsp; <a href='state.php?editid=$rs[state_id]' CLASS='btn btn-info'>Edit</a>  <a href='viewstate.php?deleteid=$rs[state_id]' onclick='return delconfirm()' CLASS='btn btn-danger'class='btn btn-danger' >Delete</a></td>
  </tr>";
  }
  ?>
  </tbody>
