...
Farmer - &nbsp;$rsseller[seller_name]</td>								
						        ...
						        <td>&nbsp;$rs[task]</td>
						        <td>&nbsp;$rscity[city],<br>&nbsp;$rsstate[state] </td>
						        <td>Seller - &nbsp;";
								if($rs['seller_status'] == "")
								{
									echo "No updates yet";
...
$date2 = new DateTime($rs['to_date']); 
								   ...
								   echo "<a href='viewworkerrequestdetailed.php?viewid=$rs[worker_request_id]' class='btn btn-info'>View</a></td></tr>";
									}
									else if(isset($_SESSION['workerid']))
									{ 
								   echo " <td><a href='viewworkerrequestdetailed.php?viewid=$rs[worker_request_id]' class='btn btn-info'>View</a></td></tr>";
									}
									else
									{										
								   echo " <td>&nbsp;";
